              ...
              <div className="md:col-span-2 space-y-4">
                 <div className="flex items-center justify-between">
                    ...
                    <button 
                       ...
                       disabled={syncing}
                       className="text-[10px] font-bold text-electric-blue hover:text-white flex items-center gap-1.5 px-2 py-1 bg-electric-blue/10 rounded-md border border-electric-blue/20 transition-all hover:bg-electric-blue/20"
                    >
